...
def q_learning(env, num_episodes, discount_factor=1.0, alpha=0.5, epsilon=0.1, debug_every=100):
    """
...
if __name__ == '__main__':
    ...
    Q, stats, rewards = q_learning(env, 20, debug_every=10)
    plotting.plot_episode_stats(stats)
    
    # Test
    env.reset_prices(test_prices)
    env.reset()
    Q, stats, rewards = q_learning(env, 1, debug_every=1)
